    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center p-6 overflow-hidden font-sans selection:bg-dark-teal-500/30 selection:text-onyx-900 dark:selection:text-platinum-50">
            ...
            >
                ...
                <h2 className="text-3xl font-extrabold text-onyx-900 dark:text-platinum-50 tracking-tight mb-2 group-hover:text-dark-teal-700 dark:group-hover:text-white transition-colors">Faculty Access</h2>
                <p className="text-sm font-semibold text-onyx-500 dark:text-onyx-400 mb-6">Manage courses & student records</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-20">
                    <div>
                        <label htmlFor="facultyId" className="block text-xs font-bold uppercase tracking-widest text-onyx-500 dark:text-onyx-400 mb-2 pl-1">
                            Faculty ID
                        </label>
